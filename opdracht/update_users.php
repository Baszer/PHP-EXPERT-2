...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
  <div class="container-fluid">
    ...
    <main class="form-signin">
      ...
      $stmttasks->execute();
        foreach($stmttasks as $rows){
            ...
            $telefoon = $rows['telefoonnummer'];
             ...
             echo "<input type='text' placeholder='voornaam' class='form-control' name='subject' id='subject' value='$voornaam'>";
             echo "<input type='text' placeholder='achternaam' class='form-control' name='subject1' id='subject1' value='$achternaam'>";
             echo "<input type='text' placeholder='wachtwoord' class='form-control' name='subject2' id='subject2' value='$password'>";
             echo "<input type='text' placeholder='email' class='form-control' name='subject3' id='subject3' value='$emailpf'>";
             echo "<input type='text' placeholder='telefoon' class='form-control' name='subject4' id='subject4' value='$telefoon'>";
      ...
      $stmt4 = $db_conn->prepare("UPDATE users SET telefoonnummer = '$telefoonv' WHERE id = '$uid'");
